    ...
    render() {
        ...
        return (
            <Card
                ...
                subtitle="If you keep this field empty, WhiteHat Security Home will use <a href='https://1.1.1.1/' target='_blank'>Cloudflare DNS</a> as an upstream. Use tls:// prefix for DNS over TLS servers."
