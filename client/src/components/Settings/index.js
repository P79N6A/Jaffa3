...
export default class Settings extends Component {
    settings = {
        ...
        safebrowsing: {
            enabled: false,
            title: 'Use WhiteHat Security browsing security web service',
            subtitle: 'WhiteHat Security Home will check if domain is blacklisted by the browsing security web service. It will use privacy-friendly lookup API to perform the check: only a short prefix of the domain name SHA256 hash is sent to the server.',
        },
        parental: {
            enabled: false,
            title: 'Use WhiteHat Security parental control web service',
            subtitle: 'WhiteHat Security Home will check if domain contains adult materials. It uses the same privacy-friendly API as the browsing security web service.',
        },
        safesearch: {
            enabled: false,
            title: 'Enforce safe search',
            subtitle: 'WhiteHat Security Home can enforce safe search in the following search engines: Google, YouTube, Bing and Yandex.',
        },
    };
