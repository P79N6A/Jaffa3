...
func main() {
	log.Printf("WhiteHat Security Home web interface backend, version %s\n", VersionString)
...
func upgradeConfig() error {
	...
	if config.SchemaVersion > SchemaVersion {
		...
		return fmt.Errorf("configuration file is supposed to be used with a newer version of WhiteHat Security Home, schema=%d", config.SchemaVersion)
	}
